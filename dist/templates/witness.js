...
const witnessTemplate = (utxo, signatories, sigs, script) => {
    ...
    const tapTweakPrefix = lib_core_1.taproot.tapRoot(wiz_data_1.default.fromHex(innerKey), [wiz_data_1.default.fromHex(script.substring(2))], lib_core_1.TAPROOT_VERSION.BITCOIN).tweak.hex.substring(0, 2) === "02" ? "c0" : "c1";
    let final = "";
